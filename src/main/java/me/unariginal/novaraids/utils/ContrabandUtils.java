...
public class ContrabandUtils {
    public static boolean hasContraband(ServerPlayerEntity player, Raid raid) {
        // Party Check!
        ...
        ParseContext parseContext = ParseContext.builder().player(player).raid(raid).category(category).build();

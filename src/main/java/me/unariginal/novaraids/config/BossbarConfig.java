...
import static me.unariginal.novaraids.utils.TextUtils.deserializeComponent;
...
public class BossbarConfig {
    ...
    public BossBar createBossbar(Raid raid) {
        ...
        return BossBar.bossBar(deserializeComponent(barText, ParseContext.builder().raid(raid).build()), 1f, color, style);
    }
}
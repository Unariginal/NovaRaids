...
public class HistoryMinimumPlayers implements RaidHistoryPlaceholder {
    @Override
    public GenericResult handle(RaidHistory raidHistory, List<String> args) {
        return GenericResult.valid(raidHistory.minPlayers);
    }

    @Override
    public List<String> id() {
        return List.of("history_min_players", "history_minimum_players");
    }
}

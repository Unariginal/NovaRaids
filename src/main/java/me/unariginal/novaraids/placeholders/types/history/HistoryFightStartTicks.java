...
public class HistoryFightStartTicks implements RaidHistoryPlaceholder {
    @Override
    public GenericResult handle(RaidHistory raidHistory, List<String> args) {
        return GenericResult.valid(raidHistory.fightStartTime);
    }

    @Override
    public List<String> id() {
        return List.of("history_fight_start_ticks");
    }
}

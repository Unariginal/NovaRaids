...
public class ModifierMinimumPartySizeOffset implements CategoryModifierPlaceholder {
    @Override
    public GenericResult handle(CategoryModifier modifier, List<String> args) {
        return GenericResult.valid(modifier.raidDetailModifiers.minimumPartySizeOffset);
    }

    @Override
    public List<String> id() {
        return List.of("modifier_minimum_party_size_offset", "modifier_min_party_size_offset");
    }
}

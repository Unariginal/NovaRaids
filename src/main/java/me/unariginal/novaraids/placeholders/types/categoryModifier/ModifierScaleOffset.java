...
public class ModifierScaleOffset implements CategoryModifierPlaceholder {
    @Override
    public GenericResult handle(CategoryModifier modifier, List<String> args) {
        return GenericResult.valid(modifier.bossPokemonModifiers.scaleOffset);
    }

    @Override
    public List<String> id() {
        return List.of("modifier_scale_offset");
    }
}

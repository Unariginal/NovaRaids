...
public class RaidParticipatingPlayers implements ServerPlaceholder {
    @Override
    public GenericResult handle(List<String> args) {
        ...
        return GenericResult.valid(raid.participatingPlayers.size());
    }

    @Override
    public List<String> id() {
        return List.of("raid_player_count");
    }
}

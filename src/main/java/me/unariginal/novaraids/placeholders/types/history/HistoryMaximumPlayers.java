...
public class HistoryMaximumPlayers implements RaidHistoryPlaceholder {
    @Override
    public GenericResult handle(RaidHistory raidHistory, List<String> args) {
        return GenericResult.valid(raidHistory.maxPlayers);
    }

    @Override
    public List<String> id() {
        return List.of("history_max_players", "history_maximum_players");
    }
}

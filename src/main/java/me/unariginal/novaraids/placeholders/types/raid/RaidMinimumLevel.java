...
public class RaidMinimumLevel implements ServerPlaceholder {
    @Override
    public GenericResult handle(List<String> args) {
        ...
        return GenericResult.valid(raid.boss.raidDetails.minimumLevel);
    }

    @Override
    public List<String> id() {
        return List.of("raid_minimum_level", "raid_min_level");
    }
}

...
public class HistoryBossAbility implements RaidHistoryPlaceholder {
    @Override
    public GenericResult handle(RaidHistory raidHistory, List<String> args) {
        return GenericResult.valid(raidHistory.boss.ability);
    }

    @Override
    public List<String> id() {
        return List.of("history_boss_ability");
    }
}

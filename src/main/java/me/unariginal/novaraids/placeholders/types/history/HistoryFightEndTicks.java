...
public class HistoryFightEndTicks implements RaidHistoryPlaceholder {
    @Override
    public GenericResult handle(RaidHistory raidHistory, List<String> args) {
        return GenericResult.valid(raidHistory.fightEndTime);
    }

    @Override
    public List<String> id() {
        return List.of("history_fight_end_ticks");
    }
}

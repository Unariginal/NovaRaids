...
public class HistoryBossFriendship implements RaidHistoryPlaceholder {
    @Override
    public GenericResult handle(RaidHistory raidHistory, List<String> args) {
        return GenericResult.valid(raidHistory.boss.friendship);
    }

    @Override
    public List<String> id() {
        return List.of("history_boss_friendship");
    }
}

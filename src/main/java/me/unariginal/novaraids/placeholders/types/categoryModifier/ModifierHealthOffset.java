...
public class ModifierHealthOffset implements CategoryModifierPlaceholder {
    @Override
    public GenericResult handle(CategoryModifier modifier, List<String> args) {
        return GenericResult.valid(modifier.bossDetailModifiers.baseHealthOffset);
    }

    @Override
    public List<String> id() {
        return List.of("modifier_health_offset");
    }
}

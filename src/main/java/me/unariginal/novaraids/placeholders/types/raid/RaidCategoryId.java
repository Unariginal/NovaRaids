...
public class RaidCategoryId implements RaidPlaceholder {
    @Override
    public GenericResult handle(@Nullable Raid raid, List<String> args) {
        ...
        if (raid.category == null) return GenericResult.invalid("Null Category");

        return GenericResult.valid(raid.category.categoryId);
    }

    @Override
    public List<String> id() {
        return List.of("raid_category_id");
    }
}
